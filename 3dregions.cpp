...
int main(int argc, char** argv) {
  ...
  constraints << "n_regions_ = " << 2 << ";\n\n";
  	...
  	// define_cube_as_constraints(constraints, 0, 0.0, 85.0, 50.0, 70.0, 0.0, 10.0);
	...
	// define_cube_as_constraints(constraints, 1, 80.0, 100.0, 80.0, 100.0, 0.0, 10.0); //building B
	// define_cube_as_constraints(constraints, 2, 20.0, 40.0, 60.0, 80.0, 0.0, 10.0); //building C
	// define_cube_as_constraints(constraints, 3, 60.0, 80.0, 20.0, 40.0, 0.0, 10.0); //building D

  	// define_cube_as_constraints(constraints, 0, 0.0, 20.0, 0.0, 20.0, 0.0, 3.0); //base station A
	// define_cube_as_constraints(constraints, 1, 70.0, 80.0, 80.0, 100.0, 0.0, 3.0); //building B drop off
	// define_cube_as_constraints(constraints, 2, 10.0, 20.0, 60.0, 80.0, 0.0, 3.0); //building C drop off
	// define_cube_as_constraints(constraints, 3, 50.0, 60.0, 20.0, 40.0, 0.0, 3.0); //building D drop off

	define_cube_as_constraints(constraints, 3, 0.0, 100.0, 0.0, 100.0, 10.0, 20.0); //sky
